...
public class Sorcier extends Personnage implements Victime {
    ...
    public void attaque(Victime v) {
        if ((!(this.detruit()) || v.detruit()))  //on teste si l'un des deux personnages est mort si c'est le cas il ne se passe rien.
        {
            this.addVie(v.subitCharme((int) (this.getVie() * this.pouvoir)));
